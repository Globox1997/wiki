---
title: Wooden Francisca
project: medievalweapons
summary: medievalweapons item wooden francisca
---
# Wooden Francisca
...
<table class="left_table">
    ...
    <img src="/wiki/assets/medievalweapons/items/wooden_francisca.png" loading="lazy" class="right_img_table"/>
</div>

## Description
A wooden francisca is an early game [weapon](https://minecraft.wiki/w/Weapon) that deals [damage](https://minecraft.wiki/w/Damage) and can be used as a throwable [projectile](https://minecraft.wiki/w/Entity#Types_of_entities).
...
output[medievalweapons:wooden_francisca, Wooden Francisca]
</div>
</div>
