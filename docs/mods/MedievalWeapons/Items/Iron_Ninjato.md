...
summary: medievalweapons item iron ninjato
---
# Iron Ninjato
...
<table class="left_table">
    ...
    <img src="/wiki/assets/medievalweapons/items/iron_ninjato.png" loading="lazy" class="right_img_table"/>
</div>

## Description
An iron ninjato is a mid game [weapon](https://minecraft.wiki/w/Weapon) that deals [damage](https://minecraft.wiki/w/Damage) and can be dual wielded.
...
output[medievalweapons:iron_ninjato, Iron Ninjato]
</div>
</div>
