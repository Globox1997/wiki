...
summary: medievalweapons item stone mace
---
# Stone Mace
...
<table class="left_table">
    ...
    <img src="/wiki/assets/medievalweapons/items/stone_mace.png" loading="lazy" class="right_img_table"/>
</div>

## Description
A stone Mace is an early game [weapon](https://minecraft.wiki/w/Weapon) that deals [damage](https://minecraft.wiki/w/Damage) and applies [stun](/wiki/mods/MedievalWeapons/Effects/Stun) to [players](https://minecraft.wiki/w/Player) and [mobs](https://minecraft.wiki/w/Mob).
...
output[medievalweapons:stone_mace, Stone Mace]
</div>
</div>
