---
title: Netherite Mace
project: medievalweapons
summary: medievalweapons item netherite mace
---
# Netherite Mace
...
<table class="left_table">
    ...
    <img src="/wiki/assets/medievalweapons/items/netherite_mace.png" loading="lazy" class="right_img_table"/>
</div>

## Description
An netherite mace is a late game [weapon](https://minecraft.wiki/w/Weapon) that deals [damage](https://minecraft.wiki/w/Damage) and applies [stun](/wiki/mods/MedievalWeapons/Effects/Stun) to [players](https://minecraft.wiki/w/Player) and [mobs](https://minecraft.wiki/w/Mob). A netherite mace has resistance to [fire](https://minecraft.wiki/w/Fire) and [lava](https://minecraft.wiki/w/Lava) when dropped as an [item](https://minecraft.wiki/w/Item).
...
output[medievalweapons:netherite_mace, Netherite Mace ]
