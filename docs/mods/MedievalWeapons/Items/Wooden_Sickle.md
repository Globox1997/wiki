...
summary: medievalweapons item wooden sickle
---
# Wooden Sickle
...
<table class="left_table">
    ...
    <img src="/wiki/assets/medievalweapons/items/wooden_sickle.png" loading="lazy" class="right_img_table"/>
</div>
...
output[medievalweapons:wooden_sickle, Wooden Sickle]
</div>
</div>
