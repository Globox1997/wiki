---
title: Netherite War Axe
project: medievalweapons
summary: medievalweapons item netherite war axe
---
# Netherite War Axe
...
<table class="left_table">
    ...
    <img src="/wiki/assets/medievalweapons/items/netherite_big_axe.png" loading="lazy" class="right_img_table"/>
</div>

## Description
An netherite war axe is a late game [weapon](https://minecraft.wiki/w/Weapon) that deals [damage](https://minecraft.wiki/w/Damage) and has built in [sweeping](https://minecraft.wiki/w/Sword#Sweeping) attack. A netherite war axe has resistance to [fire](https://minecraft.wiki/w/Fire) and [lava](https://minecraft.wiki/w/Lava) when dropped as an [item](https://minecraft.wiki/w/Item).
...
output[medievalweapons:netherite_big_axe, Netherite War Axe ]
</div>
</div>
