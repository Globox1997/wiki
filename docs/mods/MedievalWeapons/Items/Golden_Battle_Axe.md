---
title: Golden Battle Axe
project: medievalweapons
summary: medievalweapons item golden battle axe
---
# Golden Battle Axe
...
<table class="left_table">
    ...
    <img src="/wiki/assets/medievalweapons/items/golden_small_axe.png" loading="lazy" class="right_img_table"/>
</div>

## Description
A golden battle axe is a mid game [weapon](https://minecraft.wiki/w/Weapon) that deals [damage](https://minecraft.wiki/w/Damage) and has built in [knockback](https://minecraft.wiki/w/Knockback).
...
output[medievalweapons:golden_small_axe, Golden Battle Axe]
</div>
</div>
