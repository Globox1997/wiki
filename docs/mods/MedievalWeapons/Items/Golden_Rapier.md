...
summary: medievalweapons item golden rapier
---
# Golden Rapier
...
<table class="left_table">
    ...
    <img src="/wiki/assets/medievalweapons/items/golden_rapier.png" loading="lazy" class="right_img_table"/>
</div>

## Description
A golden rapier is a mid game [weapon](https://minecraft.wiki/w/Weapon) that deals [damage](https://minecraft.wiki/w/Damage) and applies [bleed](/wiki/mods/MedievalWeapons/Effects/Bleed) to [players](https://minecraft.wiki/w/Player) and [mobs](https://minecraft.wiki/w/Mob). The rapier has the highest attack speed.
...
output[medievalweapons:golden_rapier, Golden Rapier]
</div>
</div>
