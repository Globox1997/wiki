---
title: Deepslate Brick Glass
project: cupellation
summary: cupellation block deepslate brick glass
---
# Deepslate Brick Glass
...
<table class="left_table">
    ...
    <img src="/wiki/assets/cupellation/blocks/deepslate_brick_glass.png" loading="lazy" class="right_img_table"/>
</div>

## Description
The deepslate brick glass is a transparent block which is used to build a smelter out of and see the molten material inside the smelter at the same time.
...
input[
    1=sand, Sand, https://minecraft.wiki/w/Sand;
    2=quartz, Quartz, https://minecraft.wiki/w/Quartz
]
output[cupellation:deepslate_brick_glass, Deepslate Brick Glass]
</div>
</div>

## Usage
Just build the smelter wall out of the glass block to see which molten material is inside the smelter.
