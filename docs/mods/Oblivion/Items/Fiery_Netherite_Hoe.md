---
title: Fiery Netherite Hoe
project: oblivion
summary: oblivion item fiery netherite hoe
---
# Fiery Netherite Hoe
...
<table class="left_table">
    <tbody>
        ...
        <tr id="linear-top">
            ...
            <td class="second-column icon-element" icon-count="3.5" icon-id="melee" icon-exclusive></td>
        </tr>
        <tr id="linear-top">
            <td class="first-column">Attack Speed</td>
            <td class="second-column icon-element" icon-count="3" icon-id="melee_speed" icon-exclusive></td>
        </tr>
        <tr id="linear-top">
