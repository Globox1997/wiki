---
title: Fiery Netherite Shovel
project: oblivion
summary: oblivion item fiery netherite shovel
---
# Fiery Netherite Shovel
...
<table class="left_table">
    <tbody>
        <tr>
            ...
            ```
            oblivion:fiery_netherite_shovel
            ```
            </td>
        </tr>
        <tr id="linear-top">
...
## Usage
A fiery netherite shovel can be used to break soil-type materials faster. Breaking a [block](https://minecraft.wiki/w/Block) with a shovel consumes one use (one durability point). No [durability](https://minecraft.wiki/w/Durability) is consumed for [blocks](https://minecraft.wiki/w/Block) that break instantly, like [torches](https://minecraft.wiki/w/Torch) and [flowers](https://minecraft.wiki/w/Flower).[^1]  
