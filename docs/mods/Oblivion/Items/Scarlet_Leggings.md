---
title: Scarlet Leggings
project: oblivion
summary: oblivion item scarlet leggings
---
# Scarlet Leggings
...
<table class="left_table">
    ...
    <img src="/wiki/assets/oblivion/items/scarlet_leggings.png" loading="lazy" class="right_img_table"/>
</div>

## Description
Scarlet leggings is an end game [armor](https://minecraft.wiki/w/Armor) piece that provides [players](https://minecraft.wiki/w/Player) and certain [mobs](https://minecraft.wiki/w/Mob) protection from common [damage types](https://minecraft.wiki/w/Damage_type) and appear graphically on the wearer.
...
input[
    ...
    2=oblivion:fiery_netherite_leggings,Fiery Netherite Leggings, Oblivion/Items/Fiery_Netherite_Leggings, true; 
    3=oblivion:scarlet_ingot, Scarlet Ingot, Oblivion/Items/Scarlet_Ingot, true
]
output[oblivion:scarlet_leggings, Scarlet Leggings ]
</div>
