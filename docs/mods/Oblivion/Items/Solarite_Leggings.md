---
title: Solarite Leggings
project: oblivion
summary: oblivion item solarite leggings
---
# Solarite Leggings
...
<table class="left_table">
    ...
    <img src="/wiki/assets/oblivion/items/solarite_leggings.png" loading="lazy" class="right_img_table"/>
</div>

## Description
Solarite leggings is an end game [armor](https://minecraft.wiki/w/Armor) piece that provides [players](https://minecraft.wiki/w/Player) and certain [mobs](https://minecraft.wiki/w/Mob) protection from common [damage types](https://minecraft.wiki/w/Damage_type) and appear graphically on the wearer.
