---
title: Scarlet Chestplate
project: oblivion
summary: oblivion item scarlet chestplate
---
# Scarlet Chestplate
...
<table class="left_table">
    ...
    <img src="/wiki/assets/oblivion/items/scarlet_chestplate.png" loading="lazy" class="right_img_table"/>
</div>

## Description
A scarlet chestplate is an end game [armor](https://minecraft.wiki/w/Armor) piece that provides [players](https://minecraft.wiki/w/Player) and certain [mobs](https://minecraft.wiki/w/Mob) protection from common [damage types](https://minecraft.wiki/w/Damage_type) and appear graphically on the wearer.
