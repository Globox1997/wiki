...
summary: spartanweapons item mace
---
# Mace
...
<table class="left_table">
    ...
    <img src="/wiki/assets/spartanweapons/items/diamond_oak_mace.png" loading="lazy" class="right_img_table"/>
</div>

## Description
A mace is a [weapon](https://minecraft.wiki/w/Weapon) that deals [damage](https://minecraft.wiki/w/Damage).

## Obtaining
Depending on the stick variant, the handlebar of the mace is determined.

#### Crafting
<div id="crafting-table">
<div class="crafting-element" crafting-type="vanilla_crafting">
input[
    2=diamond_block, Block of Diamond, https://minecraft.wiki/w/Block_of_Diamond;
    5=diamond, Diamond, https://minecraft.wiki/w/Diamond;
    8=stick, Stick, https://minecraft.wiki/w/Stick
]
output[spartanweapons:diamond_oak_mace, Mace]
</div>
</div>
