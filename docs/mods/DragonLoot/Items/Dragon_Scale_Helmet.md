---
title: Dragon Scale Helmet
project: dragonloot
summary: dragonloot item dragon scale helmet
---
# Dragon Scale Helmet
...
output[dragonloot:dragon_helmet, Dragon Scale Helmet ]
</div>
</div>

## Usage
The dragon scale helmet can be worn in the head slot of the [inventory](https://minecraft.wiki/w/Inventory) to give <span class="icon-element" icon-count="7" icon-id="armor"></span> [protection](https://minecraft.wiki/w/Armor#Protection), 3 [armor toughness](https://minecraft.wiki/w/Armor_toughness) and 10% knockback resistance.
